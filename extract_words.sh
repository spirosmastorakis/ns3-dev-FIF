...
do
  ...
  ./waf --run "ndn-no-fuzzy-abilene --fibSize=$3 --simTime=70"
...
./extract_words ../word2vec/trunk/vectors.bin names2 $2 upper
./extract_words ../word2vec/trunk/vectors.bin routing $3 any
./waf --run "ndn-no-fuzzy-abilene --fibSize=$3 --simTime=70 --memLogs=1"
./waf --run "ndn-fuzzy-test-abilene --fibSize=$3 --simTime=70 --memLogs=1"
